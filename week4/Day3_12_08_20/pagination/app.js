...
anc1.innerText = 'Previous'
page.appendChild(anc1)

let anc2 = document.createElement('A')
anc2.setAttribute('href', '#')
anc2.innerText = '1'
anc2.addEventListener('click', function() {
    for (i = 0; i <= 20; i++) {
        alert(1)
    }
...
page.appendChild(anc2)

let anc3 = document.createElement('A')
anc3.setAttribute('href', '#')
anc3.innerText = '2'

page.appendChild(anc3)

let anc4 = document.createElement('A')
anc4.setAttribute('href', '#')
anc4.innerText = '3'

page.appendChild(anc4)

let anc5 = document.createElement('A')
anc5.setAttribute('href', '#')
anc5.innerText = '4'

page.appendChild(anc5)

let anc6 = document.createElement('A')
anc6.setAttribute('href', '#')
anc6.innerText = '5'

page.appendChild(anc6)

let anc7 = document.createElement('A')
